# Course Materials — Schoology Mirror

Mirror of the [Schoology course materials page](https://nmusd.schoology.com/course/8478718761/materials) for **AnimationIIIA: Pd:{3} Valdes - 1959**. Files marked ⬜ still need to be downloaded from Schoology and dropped into the folder listed (Schoology requires a student login, so they can't be fetched automatically).

## Manifest — every item on the course page
...
| Item | Type | Lives in this repo | Status |
|---|---|---|---|
| Submit Syllabus Signed in Class | Assignment | — (turned in on paper) | n/a |
| Syllabus Link | Web link | [`syllabus/`](syllabus/) — save PDF or paste URL | ⬜ need file/URL |
| Animation 3 At-A-Glance | Web link | [`syllabus/`](syllabus/) — save PDF or paste URL | ⬜ need file/URL |
| Supply Check | Assignment | — (checked in class) | n/a |
...
1. Open the [Schoology materials page](https://nmusd.schoology.com/course/8478718761/materials) while logged in.
2. **For PDFs/files:** click the file to download it, then upload it to the matching folder here (on GitHub: open the folder → **Add file → Upload files**).
3. **For web links:** right-click the link on Schoology → *Copy link address* → paste it into the folder's `links.md`.

Once added, flip the ⬜ to ✅ in the tables above.
