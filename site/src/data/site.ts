...
export const site = {
  ...
  course: "Animation III A",
  period: "Period 3 · Valdes",
  ...
  tools: [
    { name: "Toon Boom Harmony", role: "2D animation" },
    { name: "Storyboard Pro", role: "Boards & animatics" },
    { name: "Adobe Photoshop", role: "Backgrounds & assets" },
  ],

  links: {
    // Leave a value empty ("") to hide that link.
    github: "https://github.com/kellylynnboyle/AnimationIIIA-Pd-3-Valdes",
    email: "",
    instagram: "",
  },
};
